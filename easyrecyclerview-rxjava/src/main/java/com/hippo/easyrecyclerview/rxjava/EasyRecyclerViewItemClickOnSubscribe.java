...
final class EasyRecyclerViewItemClickOnSubscribe implements Observable.OnSubscribe<RecyclerView.ViewHolder> {

  final EasyRecyclerView view;

  public EasyRecyclerViewItemClickOnSubscribe(EasyRecyclerView view) {
    this.view = view;
  }
  ...
  public void call(final Subscriber<? super RecyclerView.ViewHolder> subscriber) {
    ...
    EasyRecyclerView.OnItemClickListener listener = new EasyRecyclerView.OnItemClickListener() {
      @Override
